...
int main(void)
{
	...
	returnValue = sndFileInput1.open("E:\\软件备份\\系统美化与屏保\\WB主题\\XP-CrystalEdition\\Royale主题\\Royale\\media\\zx.wav", interval);
	checkError(returnValue, sndFileInput2);

	returnValue = sndFileInput2.open("E:\\软件备份\\系统美化与屏保\\WB主题\\XP-CrystalEdition\\Royale主题\\Royale\\media\\qd.wav", interval);
